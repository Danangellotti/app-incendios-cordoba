...
with tab1:
    ...
    if st.button("🔍 Predecir Riesgo"):
        ...
        with st.expander("🧠 ¿Cómo se interpreta este resultado?"):
            st.write("El modelo utiliza un clasificador Random Forest con calibración isotónica, entrenado con datos históricos de clima y focos de incendio en Córdoba. Una predicción de 'MOD/ALTO' sugiere que los valores actuales son similares a los registrados en meses con alta actividad de incendios.")
...
st.markdown("---")
st.caption("Desarrollado por Dana Angellotti • Modelo Random Forest Calibrado • Streamlit App")
